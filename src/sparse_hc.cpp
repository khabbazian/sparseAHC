...
struct EdgeObj{
    ...
    public:
        ...
        EdgeObj(int _firstNode, int _secondNode, int _fNNodes, int _sNNodes, double _eweight, EdgeListItr _shadow):
...
struct WeightObj{
    ...
    const double weight;
    WeightObj(const int _firstNode, const int _secondNode, const EdgeListItr _edgeItr1, const EdgeListItr _edgeItr2, const double _weight):
        firstNode(_firstNode), secondNode(_secondNode), edgeItr1(_edgeItr1), edgeItr2(_edgeItr2), weight(_weight){}
};
