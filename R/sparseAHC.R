...
#'
#'H=sparseAHC(A,"average",FALSE)
#'plot(H);
#' 
#'@export
sparseAHC <- function(S, linkage=c("average", "single", "complete"), check.symmetry=TRUE, noOrder = FALSE) {
    ...
    .Call('sparseAHC_run_sparseAHC', PACKAGE = 'sparseAHC', S, linkage, noOrder)
}
